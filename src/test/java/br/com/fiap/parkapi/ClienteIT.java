...
import br.com.fiap.parkapi.web.dto.PageableDto;
...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201() {
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "91191064085","PIX"))
                .exchange()
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageStatus409() {
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456789"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "55352517047","PIX"))
                .exchange()
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456789"))
                .bodyValue(new ClienteCreateDto("Bobb", "00000000000", "PIX"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456789"))
                .bodyValue(new ClienteCreateDto("Bobb", "911.910.640-85","PIX"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void criarCliente_ComUsuarioNaoPermitido_RetornarErrorMessageStatus403() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456789"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "91191064085", "PIX"))
                .exchange()
    ...
    public void buscarCliente_ComIdExistentePeloCliente_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/0")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456789"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
