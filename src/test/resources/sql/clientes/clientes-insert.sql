...
insert into CLIENTES (id, nome, cpf, id_usuario,tipo_pagamento) values (10, 'Bianca Silva', '79074426050', 101,'PIX');
insert into CLIENTES (id, nome, cpf, id_usuario,tipo_pagamento) values (20, 'Roberto Gomes', '55352517047', 102,'PIX');